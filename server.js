...
/* API handler for general information about product */
...
/* API handler for various styles of the product*/
...
app.post("/reviews", (req, res) => {
  ...
  axios(options)
  // axios.post(`https://app-hrsei-api.herokuapp.com/api/fec2/hr-rfc/reviews`, {data})
  .then(() => {
    console.log('POST made it back to server');
    res.sendStatus(201)
  })
